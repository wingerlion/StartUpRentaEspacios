...
<div class="buy-sin-single">
			<div class="col-sm-5 middle-side immediate">
						...
						<div class="   right-side">
							 <a href="contact.html" class="hvr-sweep-to-right more" >Contacta al dueño</a>     
					 </div>
					</div>
					...
					<div class="video-pre">
						...
						<iframe src="https://www.youtube.com/embed/3HjZnlkXUwY" frameborder="0" allowfullscreen></iframe>
					</div>
		</div>
			...
			<div class="single-box-right right-immediate">
				...
				<div class="single-box-img ">
					...
					<div class="box-text">
						...
						<a href="single.html" class="in-box">Más Información</a>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="single-box-img">
